...
GTCEuStartupEvents.registry('gtceu:material', event => {
    ...
    event.create('galvanized_steel')
        ...
        .color(0x708feb).iconSet('metallic')
        .flags(GTMaterialFlags.GENERATE_PLATE, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('spacefaring_steel')
        ...
        .color(0xea1f1f).iconSet('metallic')
        .flags(GTMaterialFlags.GENERATE_PLATE, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_FRAME)
    ...
    //Monazite Slurry
    event.create('monazite_slurry')
        .liquid()
        //.components()
        .color('0x7a6d4c')

    //Rare-Earth Slurry
    event.create('rare_earth_slurry')
        .liquid()
        //.components()
        .color('0xb3a076')

    //Dysprosium Cation
    event.create('dysprosium_cation')
        .dust()
        .components('1x dysprosium')
        .color(0x6c7480).iconSet('metallic')

    //Dysprosium III Chloride
    event.create('dysprosium_trichloride')
        .dust()
        .components('1x dysprosium', '3x chlorine')
        .color(0xffffd6).iconSet('metallic')

    //Dysprosium III Fluoride
    event.create('dysprosium_trifluoride')
        .dust()
        .components('1x dysprosium', '3x fluorine')
        .color(0xf7f7ed).iconSet('metallic')

    //Calcium Fluoride
    event.create('calcium_fluoride')
        .dust()
        .components('1x calcium', '2x fluorine')
        .color(0xc7c1ab).iconSet('metallic')
})