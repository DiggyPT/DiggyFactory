WorldgenEvents.remove(event => {
  event.removeFeatureById('underground_ores', [
    'bountiful_saplings:blossom_ore',
    'bountiful_saplings:grove_ore',
    'bountiful_saplings:sprout_ore',
    'bountiful_saplings:verdant_ore',
    'luckytntmod:gunpowder_ores',
    'luckytntmod:uranium_ores',
