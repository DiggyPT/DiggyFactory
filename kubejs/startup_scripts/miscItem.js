...
StartupEvents.registry('item', event => {
    ...
    .displayName("Ion-Exchange Resin Beads")
    .texture("kubejs:item/ion_exchange_resin_beads")

    event.create('perfect_silk')
    .displayName("Perfect Silk")
    .texture("kubejs:item/perfect_silk")
})